...
#(id, client_id, restaurant_id, orderDate, orderTime, status)
orders = [
    (1, 1, 1, "15.01.24", "18:29", "Abgeschlossen"),
    (2, 1, 2, "02.01.24", "20:12", "Abgeschlossen"),
    (3, 2, 3, "03.01.24", "16:32", "Abgeschlossen"),
    (4, 2, 4, "10.01.24", "17:45", "Abgeschlossen"),
    (5, 3, 5, "11.01.24", "13:24", "Abgeschlossen"),
    (6, 3, 6, "13.01.24", "15:36", "Abgeschlossen"),
    (7, 4, 3, "16.01.24", "19:23", "Abgeschlossen"),
    (8, 4, 7, "15.01.24", "20:02", "Abgeschlossen"),
    (9, 5, 8, "17.01.24", "14:05", "Abgeschlossen"),
    (10, 5, 10, "19.01.24", "18:29", "Abgeschlossen"),
]
...
cursor.execute("create table if not exists orders (id integer primary key autoincrement, client_id integer, restaurant_id integer, orderDate text, orderTime text, status text, foreign key (client_id) references client_accounts (id), foreign key (restaurant_id) references restaurants(id))")
